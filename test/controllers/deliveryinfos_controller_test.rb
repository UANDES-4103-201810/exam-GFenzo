...
class DeliveryinfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deliveryinfo" do
    assert_difference('Deliveryinfo.count') do
      post deliveryinfos_url, params: { deliveryinfo: { address1: @deliveryinfo.address1, address2: @deliveryinfo.address2, name: @deliveryinfo.name, order_id: @deliveryinfo.order_id, phone: @deliveryinfo.phone } }
    end
  ...
  test "should update deliveryinfo" do
    patch deliveryinfo_url(@deliveryinfo), params: { deliveryinfo: { address1: @deliveryinfo.address1, address2: @deliveryinfo.address2, name: @deliveryinfo.name, order_id: @deliveryinfo.order_id, phone: @deliveryinfo.phone } }
