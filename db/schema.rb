...
ActiveRecord::Schema.define(version: 20180620193405) do
  ...
  create_table "pizzaorders", force: :cascade do |t|
    t.integer "order_id"
    t.integer "pizza_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["order_id"], name: "index_pizzaorders_on_order_id"
    t.index ["pizza_id"], name: "index_pizzaorders_on_pizza_id"
  end
