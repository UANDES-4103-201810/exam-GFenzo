...
class PizzasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pizza" do
    assert_difference('Pizza.count') do
      post pizzas_url, params: { pizza: { crust_id: @pizza.crust_id, recipe_id: @pizza.recipe_id, user_id: @pizza.user_id } }
    end
  ...
  test "should update pizza" do
    patch pizza_url(@pizza), params: { pizza: { crust_id: @pizza.crust_id, recipe_id: @pizza.recipe_id, user_id: @pizza.user_id } }
